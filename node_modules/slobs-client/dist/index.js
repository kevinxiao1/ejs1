...
class SlobsClient {
    ...
    static connect(url, token) {
        return new Promise((resolve, reject) => {
            const socket = new sockjs_client_1.default(url);
    ...
    onMessageHandler(data) {
        ...
        if (request) {
            if (message.error) {
                ...
                this.subscriptions[message.result.resourceId] = (res) => request.resolve(res);
            }
            else {
...
exports.SlobsClient = SlobsClient;
